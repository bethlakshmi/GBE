...
function display_bids_for_review ()
{
  ...
  echo "    <TD>\n";
  echo "      A newly submitted item.  The Class or Performance Coordinator is working\n";
  ...
  echo "    <TD>\n";
  echo "      An item that is available for review by the Class Coordinator or Performance Committee\n";
  echo "    </TD>\n";
  echo "  </tr>\n";
  echo "  <TR VALIGN=TOP>\n";
...
function show_bid_feedback_summary()
{
  ...
  echo "    <td>\n";
  echo "      An entry that was Early Accepted for Intercon\n";
  echo "    </td>\n";
  echo "  </tr>\n";
  echo "  <tr valign=\"top\">\n";
  echo "    <td bgcolor=\"#FFCCCC\">Reject It</td>\n";
  echo "    <td>\n";
  echo "      An entry that has been rejected for Intercon\n";
  echo "    </td>\n";
  echo "  </tr>\n";
  echo "  <tr valign=\"top\">\n";
