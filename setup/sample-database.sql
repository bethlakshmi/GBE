...
INSERT INTO `Con` VALUES (1,'NotYet','No','Preparations for Intercon M are gearing up, and *you* can volunteer!',33,'2012-03-27 07:03:01','The next ConCom meeting will be a virtual meeting on Sunday, April 29, 2012.','Yes','Yes');
...
) ENGINE=MyISAM AUTO_INCREMENT=13429 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Runs` (
  ...
  `StartHour` char(10) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `RunsRooms`
--

LOCK TABLES `RunsRooms` WRITE;
/*!40000 ALTER TABLE `RunsRooms` DISABLE KEYS */;
/*!40000 ALTER TABLE `RunsRooms` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Signup` (
  ...
  KEY `State` (`State`)
) ENGINE=MyISAM AUTO_INCREMENT=7062 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Users` VALUES (1,'2fad44e84a312944611f3706b1fc55e2','','Admin','','webmaster@intercon-m.org',0,0,'Male','','','','','','','','','','','',0,'No','EMail','Admin','Unpaid',0,0,1,'2012-04-25 03:21:50','2012-04-25 03:15:29','2012-04-25 03:15:29','2003-04-02 17:46:45');
...
-- Dump completed on 2012-04-24 23:27:17
